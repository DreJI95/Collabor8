...
const teamResolvers = {
    ...
    createTeam: async function(parent, team){
        ...
        return await Team.create(team).populate('professionals').populate('projects');
    },
    ...
    updateTeamName: async function(parent, {_id, teamName}){
        return await Team.findByIdAndUpdate( _id, teamName,{new: true}).populate('professionals').populate('projects');
    },
